            ...
            <form action="/jobs/{{ $job->id }}/apply" enctype="multipart/form-data" id="applyJob" method="post">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group ">
                        ...
                        <input class="form-control" id="email" name="email" placeholder="i.e. you@gmail.com" type="text"
                               value="{{ old('email') }}"/>
                    </div>
                    <div class="form-group ">
                    ...
                    <div class="form-group ">
                        ...
                        <input class="form-control " id="resume" name="resume" type="file">
                        <p class="text-muted"> File types: pdf,doc,docx </p>
                    </div>
                </div>

                <div class="modal-footer">
                    <button class="btn btn-primary" id="report_ad" type="submit">
                        Apply Online
                    </button>
                </div>
